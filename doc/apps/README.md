...
위 표는 저장소에 함께 배포되는 **내장 앱**입니다.
저장소에 넣지 않고 마켓플레이스에 제출하는 앱(제출 → 관리자 승인 → 배포)은
[doc/REMOTE_APPS.md](../REMOTE_APPS.md) 를 보세요. 만드는 순서·심사 기준·정지 방법이 거기 있습니다.
내장 앱으로 승격되면 이 폴더에 문서를 만들고 위 표에 한 줄을 추가하세요.
